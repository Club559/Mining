...
namespace wServer.logic.loot
{
    ...
    {
        public GoldLoot(int min = 1, int max = 100) { minGold = min;  maxGold = max; }

        public int maxGold { get; private set; }
        public int minGold { get; private set; }
        public Item GetLoot(Random rand)
        {
            short minItemId = 0x1965;
            short maxItemId = 0x1969;
            switch(maxGold)
            {
                case 1:
                    maxItemId = 0x1965; break;
                case 5:
                    maxItemId = 0x1966; break;
                case 10:
                    maxItemId = 0x1967; break;
                case 50:
                    maxItemId = 0x1968; break;
                case 100:
                    maxItemId = 0x1969; break;
            }
            switch (minGold)
            {
                case 1:
                    minItemId = 0x1965; break;
                case 5:
                    minItemId = 0x1966; break;
                case 10:
                    minItemId = 0x1967; break;
                case 50:
                    minItemId = 0x1968; break;
                case 100:
                    minItemId = 0x1969; break;
            }
            return XmlDatas.ItemDescs[(short)rand.Next(minItemId, maxItemId + 1)];
        }
    }
