...
namespace wServer.realm
{
    ...
    public class RealmManager
    {
        ...
        public static readonly Dictionary<int, Mine> Mines = new Dictionary<int, Mine>();
        ...
        public static Mine MineWorld(int newlvl)
        {
            if (!Mines.ContainsKey(newlvl))
            {
                Mine mine = (Mine)AddWorld(new Mine(newlvl));
                Mines.Add(newlvl, mine);
                return Mines[newlvl];
            }
            else
            {
